...
> **서빙 URL**: `https://raw.githubusercontent.com/temptation0924-design/claude-docs-public/main/CLAUDE-core_v1.md`
> **Fallback URL**: `https://raw.githubusercontent.com/temptation0924-design/claude-docs-public/main/INTEGRATED.md`
...
> 아래 트리거 감지 시 즉시 WebFetch로 해당 URL 로드. `BASE` = `https://raw.githubusercontent.com/temptation0924-design/claude-docs-public/main`
...
2. **jsDelivr 미러** (GitHub rate limit 우회): `https://cdn.jsdelivr.net/gh/temptation0924-design/claude-docs-public@main/<path>`
